  ...
  head: () => ({
    meta: [
      { title: "Text-to-SQL — Natural Language Interface" },
      {
        name: "description",
        content:
          "AI-powered Text-to-SQL interface that turns natural language questions into instant database insights.",
      },
      {
        property: "og:title",
        content: "Text-to-SQL — Natural Language Interface",
      },
      {
        property: "og:description",
        content:
          "AI-powered Text-to-SQL interface that turns natural language into SQL.",
      },
    ],
  }),
  component: Welcome,
            ...
            {[
              {
                ...
                desc: "Ask in English, Hebrew or Arabic",
              },
              {
                title: "Instant SQL",
                desc: "AI generates queries in real time",
              },
              {
                title: "Safe & Read-only",
                desc: "SELECT-only execution layer",
              },
            ].map((f) => (
              <div
                key={f.title}
                className="glass rounded-2xl p-5 text-start animate-slide-up"
              >
